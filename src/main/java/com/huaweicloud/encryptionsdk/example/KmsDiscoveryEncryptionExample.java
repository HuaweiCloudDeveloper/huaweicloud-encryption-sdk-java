...
public class KmsDiscoveryEncryptionExample {
    ...
    public static void main(String[] args) throws IOException, DecoderException, NoSuchAlgorithmException {
        ...
        // discover解密
        HuaweiConfig huaweiConfigDiscovery = HuaweiConfig.builder().sk(SECRET_ACCESS_KEY).ak(ACCESS_KEY).build();
        ...
        Validate.isTrue(PLAIN_TEXT.getBytes(StandardCharsets.UTF_8).equals(decrypt.getResult()));
    }
}
